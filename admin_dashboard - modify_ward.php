                ...
                <div class="section-title">
                  <!-- ====== Login Section ======= -->
                    <section id="appointment" class="appointment section-bg">
                      ...
                      <form action="modify_ward.php" method="post" role="form" class="php-email-form">
                          <div class="row">
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                              <label for="Ward_ID">Ward ID</label>
                             <input class="form-control" type="text" id="Ward_ID" name="Ward_ID">
                            </div>
                            <hr>
                            <hr>
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                              <label for="DOC_ID">Assigned Doctor</label>
                              <div>
                              ...
                              <?php
                                  ...
                                  $resultCheck = mysqli_num_rows($result);
                                      ...
                                      if($resultCheck > 0){
                                          ...
                                          echo "<option value=".$row['E_ID'].">Doctor ID :- ".$row['E_ID']."  Doctor name :- ".$row['First_Name']." ".$row['Last_Name']."</option>";
                                          }
                                      }
                            ...
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                              ...
                              <input class="form-control" type="text" id="beds" name="beds">
                            </div>
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                            ...
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                              <label for="Filled_beds">Filled beds</label>
                              <input class="form-control" type="text" id="Filled_beds" name="Filled_beds">
                            </div>
