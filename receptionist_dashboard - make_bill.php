                ...
                <div class="section-title">
                  <!-- ====== Login Section ======= -->
                    <section id="appointment" class="appointment section-bg">
                      ...
                      <form action="make_bill.php" method="post" role="form" class="php-email-form">
                          <div class="row">
                              <div class="col-md-4 form-group mt-3 mt-md-0">
                              <label for="E_ID">Bill Prepared Employee</label>
                              <div>
                              ...
                              <?php
                                  ...
                                  $resultCheck = mysqli_num_rows($result);
                                      ...
                                      if($resultCheck > 0){
                                          ...
                                          echo "<option value=".$row['E_ID'].">Employee ID :- ".$row['E_ID']."  Receptionist name :- ".$row['First_Name']." ".$row['Last_Name']."</option>";
                                          }
                                      }
                            ...
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                              ...
                              <?php
                                  ...
                                  $resultCheck = mysqli_num_rows($result);
                                      ...
                                      if($resultCheck > 0){
                                          while($row = mysqli_fetch_assoc($result)){
                                          echo "<option value=".$row['P_ID'].">Patient ID :- ".$row['P_ID']."  Patient name :- ".$row['First_Name']." ".$row['Last_Name']."</option>";
                                          }
                                      }
                            ...
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                              ...
                              <input class="form-control" type="text" id="Doctor_Charge" name="Doctor_Charge">
                            </div>

                            <div class="col-md-4 form-group mt-3 mt-md-0">
                              <label for="Hopital_Charge">Hopital_Charge</label>
                              <input class="form-control" type="text" id="Hopital_Charge" name="Hopital_Charge">
                            </div>

                            <div class="col-md-4 form-group mt-3 mt-md-0">
                              <label for="Drug_Charge">Drug_Charge</label>
                              <input class="form-control" type="text" id="Drug_Charge" name="Drug_Charge">
                            </div>
