                ...
                <div class="section-title">
                  <!-- ====== Login Section ======= -->
                    <section id="appointment" class="appointment section-bg">
                      ...
                      <form action="receptionist_modify_patient.php" method="post" role="form" class="php-email-form">
                          <div class="row">
                            ...
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                             ...
                             <input class="form-control" type="text" id="AppointmentID" name="AppointmentID">
                            </div>
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                              <label for="WardID">Ward ID</label>
                             <input class="form-control" type="text" id="WardID" name="WardID">
                            </div>
                            <div class="col-md-4 form-group mt-3 mt-md-0">
