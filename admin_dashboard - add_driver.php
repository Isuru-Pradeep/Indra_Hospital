                ...
                <div class="section-title">
                  <!-- ====== Login Section ======= -->
                    <section id="appointment" class="appointment section-bg">
                      ...
                      <form action="add_driver.php" method="post" role="form" class="php-email-form">
                          <div class="row">
                            ...
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                              ...
                              <div>
                              <select id="Number_Plate" name="Number_Plate">
                              <?php
                                  $host = "localhost";
                                  $dbname = "indra_hospital";
                                  $username ="root";
                            ...
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                             ...
                             <input class="form-control" type="date" id="FirstDay" name="FirstDay">
                            </div>
                            <div class="col-md-4 form-group mt-3 mt-md-0">
