                  ...
                  <!-- ====== Login Section ======= -->
                    <section id="appointment" class="appointment section-bg">
                      <div class="container">
                        ...
                        <div class="section-title">
                          <h2>Drop Department</h2>
                        </div>

                      <form action="drop_department.php" method="post" role="form" class="php-email-form">
                          <div class="row">
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                              <label for="D_ID">Department ID</label>
                             <input class="form-control" type="text" id="D_ID" name="D_ID">
                            </div>
                            <div class="col-md-4 form-group mt-3 mt-md-0">
                              <label for="D_Name">Department Name</label>
                             <input class="form-control" type="text" id="D_Name" name="D_Name">
                            </div>
